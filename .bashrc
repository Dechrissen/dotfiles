...
if [ "$color_prompt" = yes ]; then
    PS1='${debian_chroot:+($debian_chroot)}\[\033[01;33m\]\u\[\033[01;36m\]@\[\033[01;33m\]\h \[\033[01;34m\]\w\[\033[00m\]\$ '
else
...
alias neofetch="clear && neofetch --kernel_shorthand on --de_version on --gtk2 "off" --gtk3 "off" --disk_show '/dev/nvme0n1p2' '/dev/sda1'  --disk_subtitle name --disk_percent on --cpu_cores "physical" --cpu_display "barinfo"  --cpu_temp "C" --memory_percent "on" --memory_display "barinfo" --bar_char '=' '-' --bar_border "on" --bar_colors 6 8 --ascii_distro "Manjaro" --ascii_colors 6 3  --colors 3 6 8 3 8 6 --color_blocks "off" --os_arch on --refresh_rate on "
